...
namespace IntelligenceCloud.Models
{
    ...
    public partial class IntelligenceCloudEntities : DbContext
    {
        ...
        public virtual int GetRoleAndFeature(Nullable<int> memberId)
        {
            var memberIdParameter = memberId.HasValue ?
                new ObjectParameter("MemberId", memberId) :
                new ObjectParameter("MemberId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GetRoleAndFeature", memberIdParameter);
        }
    
        public virtual int GetRoleAndMember(Nullable<int> roleNum)
        {
            var roleNumParameter = roleNum.HasValue ?
                new ObjectParameter("RoleNum", roleNum) :
                new ObjectParameter("RoleNum", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GetRoleAndMember", roleNumParameter);
        }
    }
}
